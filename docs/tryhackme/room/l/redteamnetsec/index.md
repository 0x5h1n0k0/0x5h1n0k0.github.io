...
### __Rely on a Different Protocol__
...
### __Manipulate (Source) TCP/UDP Port__
...
### __Use Session Splicing (IP Packet Fragmentation)__
...
### __Encrypt the Communication Channel__
